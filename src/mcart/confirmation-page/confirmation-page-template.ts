...
<% var cartItemsTotal = orderModel.cartItemsTotal %>
<% var shippingDetails = orderModel.shippingDetails %>
<% var couponDetails = orderModel.couponDetails %>
<% var taxAmount = orderModel.taxAmount %>
